  ...
  return (
    <footer className="bg-foreground text-white pt-16 pb-8">
      <div className="mx-auto max-w-[1440px] px-5 sm:px-6 lg:px-12">
        ...
        {/* Map & Info di dalam satu row */}
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          {/* Map */}
          <div className="rounded-2xl overflow-hidden h-[220px] md:h-[260px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.8447987951026!2d106.79138834025402!3d-6.284123161538714!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f1ae706b0769%3A0x505fe488419d09ea!2sSMK%20Negeri%2020%20Jakarta%20Selatan!5e0!3m2!1sid!2sid!4v1782743835125!5m2!1sid!2sid"
              width="100%"
              height="100%"
